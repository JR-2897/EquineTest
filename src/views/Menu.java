...
public class Menu {
	...
	public void choix() {
		...
		System.out.println("13 Générer les données de démo dans la base");
		System.out.println("---------------------------------------------------------------");
		...
		while (mustContinu) {
			...
			while (isNotChoice) {
				...
				if (choice.matches("2")) {
					...
					System.out.println("Ca ne correspond a aucun choix");
				}
			}
		}
	}
